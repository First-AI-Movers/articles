...
| Term | Expected | Found |
|---|---|---|
| EU AI Act | Reglamento de Inteligencia Artificial de la UE | [x] |
| GDPR | RGPD | [x] |
| SME | PYME | [x] |
| conformity assessment | evaluación de conformidad | [x] |
| high-risk AI system | sistema de IA de alto riesgo | [x] |
| AI governance | gobernanza de IA | [x] |
| risk management | gestión de riesgos | [x] |
| data sovereignty | soberanía de datos | [x] |
