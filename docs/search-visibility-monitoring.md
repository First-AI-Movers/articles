...
The migration pre-flight is written up in [`docs/WWW_MIGRATION_SEO_CHECKLIST.md`](WWW_MIGRATION_SEO_CHECKLIST.md) (ROADMAP N4) — it closes this defect at §6 and covers the 306 archived articles whose `canonical_url` lives on www.
