...
31. **E37** — erratum / correction protocol (XS, pure docs/policy; unblocks scholarly posture for later epics). **Next recommended epic.**
32. **E32** — *(research only)* track C2PA written-content tooling; revisit Q4 2026.
