...
32. **E40** — multi-property pattern doc + cookiecutter template (XS, depends on E18 dual-license shipping). **Next recommended epic.**
33. **E32** — *(research only)* track C2PA written-content tooling; revisit Q4 2026.
